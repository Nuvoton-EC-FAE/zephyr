...
NPCX_REG_SIZE_CHECK(shm_reg, 0x0d0);
...
NPCX_REG_OFFSET_CHECK(shm_reg, SMCE_STS, 0x080);
NPCX_REG_OFFSET_CHECK(shm_reg, WINE_SIZE, 0x087);
NPCX_REG_OFFSET_CHECK(shm_reg, SHAW3_SEM, 0x088);
NPCX_REG_OFFSET_CHECK(shm_reg, WIN_BASE3, 0x0a0);
NPCX_REG_OFFSET_CHECK(shm_reg, HOFSE_STS, 0x0c8);
NPCX_REG_OFFSET_CHECK(shm_reg, COFS3, 0x0cc);
